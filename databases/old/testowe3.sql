...
-- Started on 2025-04-17 12:52:05
...
--
-- TOC entry 3548 (class 0 OID 16387)
-- Dependencies: 217
...
--
-- TOC entry 3550 (class 0 OID 16394)
-- Dependencies: 219
-- Data for Name: auta; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- TOC entry 3552 (class 0 OID 16402)
-- Dependencies: 221
-- Data for Name: auta_zdj; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- TOC entry 3554 (class 0 OID 16408)
-- Dependencies: 223
...
--
-- TOC entry 3556 (class 0 OID 16412)
-- Dependencies: 225
...
--
-- TOC entry 3558 (class 0 OID 16416)
-- Dependencies: 227
...
--
-- TOC entry 3560 (class 0 OID 16420)
-- Dependencies: 229
...
--
-- TOC entry 3561 (class 0 OID 16425)
-- Dependencies: 230
...
--
-- TOC entry 3564 (class 0 OID 16430)
-- Dependencies: 233
...
--
-- TOC entry 3566 (class 0 OID 16434)
-- Dependencies: 235
-- Data for Name: czarna_lista; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- TOC entry 3570 (class 0 OID 16446)
-- Dependencies: 239
...
--
-- TOC entry 3574 (class 0 OID 16456)
-- Dependencies: 243
...
--
-- TOC entry 3575 (class 0 OID 16461)
-- Dependencies: 244
-- Data for Name: historia_zmian; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.historia_zmian (id_historii, tabela_zrodlowa, id_rekordu, operacja, data_operacji, miasto, ulica, nr_ulicy, kod_pocztowy, id_user, imie, nazwisko, pesel, email, id_zamieszkania) FROM stdin;
1	miasta	1	INSERT	2025-04-17 10:37:53.750728	Strzegom	Wałbrzyska	3	58-150	\N	\N	\N	\N	\N	\N
2	uzytkownicy	1	INSERT	2025-04-17 10:37:53.750728	Strzegom	Wałbrzyska	3	58-150	1	Paweł	Drewniak	00000000000	user@user.pl	1
\.


--
-- TOC entry 3577 (class 0 OID 16468)
-- Dependencies: 246
-- Data for Name: miasta; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.miasta (id_zamieszkania, miasto, ulica, nr_ulicy, kod_pocztowy) FROM stdin;
1	Strzegom	Wałbrzyska	3	58-150
\.


--
-- TOC entry 3579 (class 0 OID 16476)
-- Dependencies: 248
-- Data for Name: uzytkownicy; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.uzytkownicy (id_user, imie, nazwisko, "PESEL", email, haslo, id_zamieszkania) FROM stdin;
1	Paweł	Drewniak	00000000000	user@user.pl	password	1
\.


--
-- TOC entry 3581 (class 0 OID 16484)
-- Dependencies: 250
-- Data for Name: wypozyczenie; Type: TABLE DATA; Schema: public; Owner: admin
--
...
-- Dependencies: 218
-- Name: admin_id_admin_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--
...
-- Dependencies: 220
-- Name: auta_id_auta_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.auta_id_auta_seq', 1, false);


--
-- TOC entry 3598 (class 0 OID 0)
-- Dependencies: 222
-- Name: auta_zdj_id_zdj_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.auta_zdj_id_zdj_seq', 1, false);
...
-- Dependencies: 236
-- Name: czarna_lista_id_bl_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.czarna_lista_id_bl_seq', 1, false);
...
-- Dependencies: 245
-- Name: historia_zmian_id_historii_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.historia_zmian_id_historii_seq', 2, true);


--
-- TOC entry 3610 (class 0 OID 0)
-- Dependencies: 247
-- Name: miasta_id_zamieszkania_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.miasta_id_zamieszkania_seq', 1, true);


--
-- TOC entry 3611 (class 0 OID 0)
-- Dependencies: 249
-- Name: uzytkownicy_id_user_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.uzytkownicy_id_user_seq', 1, true);


--
-- TOC entry 3612 (class 0 OID 0)
-- Dependencies: 251
-- Name: wypozyczenie_id_wypozyczenia_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.wypozyczenie_id_wypozyczenia_seq', 1, false);
...
-- Completed on 2025-04-17 12:52:05
